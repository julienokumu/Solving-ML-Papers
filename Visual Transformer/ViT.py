...
class VisionTransformer(nn.Module):
    def __init__(self, emb_dim=768, mlp_dim=3072, num_classes=1000, dropout=0.1, img_size=224, patch_size=16, in_channels=3, depth=12, num_heads=12):
        ...
        self.pos_emb = PositionalEmbedding(self.num_patches, emb_dim)
